...
namespace mjjames.AdminSystem.Repositories
{
	...
	{
		private readonly DataContexts.Archive.archiveDataContext _adc = new DataContexts.Archive.archiveDataContext(ConfigurationManager.ConnectionStrings["CMSArchiveDataConnectionString"].ConnectionString);
