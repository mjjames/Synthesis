...
namespace mjjames.AdminSystem.DataContexts
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="adry")]
    ...
    partial void Deletekeyvalue(mjjames.AdminSystem.DataEntities.keyvalue instance);
		...
		public AdminDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["adryConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
...
namespace mjjames.AdminSystem.DataEntities
{
    ...
    partial void OnurlChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_project_fkey", DbType="Int NULL")]
    ...
    partial void OnactiveChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="lookup_project", Storage="_projects", ThisKey="lookup_key", OtherKey="category_lookup")]
    ...
    partial void Ondate_createdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_date_created", DbType="DateTime", IsDbGenerated=true)]
		...
		public page page1
		{
			...
			set
			{
							...
							|| (this._page1.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._page_fkey = default(Nullable<int>);
					}
    ...
    partial void OnvirtualurlChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="article_Comment", Storage="_comments", ThisKey="article_key", OtherKey="ArticleKey")]
    ...
    partial void OnUserNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="article_Comment", Storage="_article", ThisKey="ArticleKey", OtherKey="article_key", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._article.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._article_key = value.article_key;
					}
					else
					{
						this._article_key = default(int);
					}
	...
	public partial class project : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _category_lookup;
    ...
    partial void OnurlChanging(string value);
    partial void OnurlChanged();
    partial void Oncategory_lookupChanging(System.Nullable<int> value);
    partial void Oncategory_lookupChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_category_lookup", DbType="Int")]
		public System.Nullable<int> category_lookup
		{
			get
			{
				return this._category_lookup;
			}
			set
			{
				if ((this._category_lookup != value))
				{
					if (this._lookup.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.Oncategory_lookupChanging(value);
					this.SendPropertyChanging();
					this._category_lookup = value;
					this.SendPropertyChanged("category_lookup");
					this.Oncategory_lookupChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="lookup_project", Storage="_lookup", ThisKey="category_lookup", OtherKey="lookup_key", IsForeignKey=true)]
		public lookup lookup
		{
			get
			{
			...
			set
			{
							...
							|| (this._lookup.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._category_lookup = value.lookup_key;
					}
					else
					{
						this._category_lookup = default(Nullable<int>);
					}
					this.SendPropertyChanged("lookup");
				}
			}
