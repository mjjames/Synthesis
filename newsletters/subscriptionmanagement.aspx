<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSystem.master" AutoEventWireup="true"
	CodeFile="subscriptionmanagement.aspx.cs" Inherits="newsletters_subscriptionmanagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<div id="colContainer">
		...
		<div id="rightCol">
			<asp:LinqDataSource ID="ldsReciprients" runat="server" ContextTypeName="adminDataClassesDataContext"
				EnableInsert="True" EnableUpdate="True" OrderBy="name" TableName="NewsletterReciprients"
				AutoPage="true" EnableDelete="True">
			</asp:LinqDataSource>
